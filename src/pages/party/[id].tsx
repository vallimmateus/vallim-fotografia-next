...
import { Party, MultiFid } from '../index.jsx';
...
export const getStaticProps: GetStaticProps<PageProps> = async (context) => {
    ...
    for (const fidObj of fids) {
        const res = await fetch('https://script.google.com/macros/s/AKfycbz-CRLaRXTcJkbUF2jW4kj8zMT99nyM6qGxyHsEolexa3AAk7zCqB6c2s3uMpmWiN64cA/exec?fid=' + fidObj.fid)
